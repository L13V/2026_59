...
//   // Motors
//   static TalonFX towerMotor = new TalonFX(TowerConstants.towerMotorId, Constants.CANBus);
//   // Configurations
//   static TalonFXConfiguration towerConfig = new TalonFXConfiguration();
//   private boolean towerConfigured = false;
//   // Controls
//   static VoltageOut voltageOut = new VoltageOut(0).withEnableFOC(true);

//   // Alerts
//   private final Debouncer towerMotorConnectedDebouncer =
...
//     // Alerts
//     towerConnectionAlert.set(
//         Robot.showHardwareAlerts() && !towerMotorConnectedDebouncer.calculate(towerConnected));
