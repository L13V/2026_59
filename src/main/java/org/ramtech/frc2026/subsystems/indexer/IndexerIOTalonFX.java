...
public class IndexerIOTalonFX implements IndexerIO {
	...
	public IndexerIOTalonFX() {
		...
		// Configure Motors
		ballTunnelConfigured = tryUntilOkWithStatus(5,
				() -> ballTunnelMotor.getConfigurator().apply(ballTunnelConfig, 0.25));
		...
		BaseStatusSignal.setUpdateFrequencyForAll(50.0, ballTunnelVoltageSig, ballTunnelVelocitySig,
				ballTunnelCurrentSig, starVoltageSig, starVelocitySig, starCurrentSig);
	...
	public void updateInputs(IndexerIOInputs inputs) {
		...
		inputs.signalsOk = BaseStatusSignal.refreshAll(ballTunnelVoltageSig, ballTunnelVelocitySig,
				ballTunnelCurrentSig, starVoltageSig, starVelocitySig, starCurrentSig);
	...
	public void applyOutputs(IndexerIOOutputs outputs) {
		switch (outputs.mode) {
			...
			case VOLTAGE :
				...
				starMotor.setControl(starVoltageOut.withOutput(outputs.starVoltageSetpoint).withEnableFOC(true));
				break;
		}
	}
}
