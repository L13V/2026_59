package org.ramtech.frc2026.generated;
...
public class TunerConstants {
	...
	private static final Slot0Configs steerGains = new Slot0Configs().withKP(90).withKI(0.01).withKD(1.0).withKS(0.1)
			.withKV(2.48).withKA(0).withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
	// When using closed-loop control, the drive motor uses the control
	// output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
	// private static final Slot0Configs driveGains = new
	// Slot0Configs().withKP(20).withKI(1.5).withKD(0.09)
	// .withKS(4.13539).withKV(1.27717); // FOC
	private static final Slot0Configs driveGains = new Slot0Configs().withKP(2.0).withKI(0.1).withKD(0.0).withKS(0.5) // TODO:
																														// check
																														// cuz
																														// its
																														// 0.5
	...
	private static final Current kSlipCurrent = Amps.of(120); // STATOR LIMIT
	...
	private static final TalonFXConfiguration steerInitialConfigs = new TalonFXConfiguration()
			.withCurrentLimits(new CurrentLimitsConfigs()
					...
					.withSupplyCurrentLimit(Amps.of(30)).withStatorCurrentLimit(Amps.of(90))
	...
	public static final CANBus kCANBus = new CANBus("RT Canivore");
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.161376953125);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(0.371337890625);
